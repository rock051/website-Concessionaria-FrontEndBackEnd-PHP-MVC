      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active"><a class="nav-link" href="Grupo5.php">Grupo 5</a></li>
          </ul>
        </div>
      </div>
    </nav>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4">
          <div class="team-member">
            <div class="thumb-container">
              <img src="../assets/images/img_01.jpeg" alt="">
        ...
        <div class="col-md-4">
          <div class="team-member">
            <div class="thumb-container">
              <img src="../assets/images/img_02.jpeg" alt="">
              <div class="hover-effect">
                <div class="hover-content">
                  <ul class="social-icons">
                    <li><a href="#"><i class="fa fa-facebook"></i></a></li>
            ...
            <div class="down-content">
              <h4>Samir Carvalho</h4>
              <span>Sistemas de Informação</span>
              <p>Matrícula: 201920351</p>
            </div>
          </div>
        </div>
      </div>
